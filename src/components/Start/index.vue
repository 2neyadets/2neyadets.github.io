<template lang="pug">
  .start__block.q-pa-xs-xs.q-pa-sm-sm.q-pa-md-md.flex.flex-center(
    ref="startBlock"
    ...
    q-card.shadow-12(style="text-align: justify" :class="$q.screen.gt.lg ? 'mx-for-project-card' : ''")
      ...
      q-separator(inset)
      q-card-section.q-px-xs-sm.q-px-md-sm.q-px-lg-lg.q-py-xs-sm.q-py-md-sm.q-py-lg-md.md-opacity
      ...
      q-card-actions.q-pa-none(align="center")
        q-btn.full-width.full-height(
          @click="$app.layout.goToSection(true)"
