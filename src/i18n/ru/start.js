export default {
  ...
  text: {
    ...
    portfolio: 'Это портфолио проектов на <a href="https://quasar.dev/">Quasar UI&#8209;Framework</a>, которые ушли в продкашн. Частичный функционал можно будет "пощупать" в диалоговых окнах. ' +
      'Обращения к методам API из проектов заменены на таймауты со статическими данными.',
  }
}
